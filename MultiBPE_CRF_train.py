...
from MultiBPE import CRFTrainWorkflow

######## User Input ########
parser = argparse.ArgumentParser(
    "Train a linear chain CRF classifier on MultiBPE predictions."
)
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Specify an alternative path to a best MultiBPE checkpoint .ckpt file "
    "or a best MultiBPE checkpoint evaluation .json file.",
)
...
parser.add_argument(
    ...
    help="Path to MultiBPE training data. Default: "
...
workflow.multibpe_ckpt = args.multibpe_ckpt
