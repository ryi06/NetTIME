...
--zscore_dir Path to directory for saving feature zscore normalization parameters. Specify this param when retrieving feature signals. (Default: ../data/datasets/training_example/train/zscore_params)
...
EXAMPLE_PICKLE="../data/datasets/training_example/train/train_minOverlap200_maxUnion600_example_path.pkl"
REGION_BED=""
SEQUENCE_LENGTH=1000
TARGET_TYPE="output_conserved"
ZSCORE_DIR="../data/datasets/training_example/train/zscore_params"
